      ...
      body: SafeArea(
        child: CustomScrollView(
          slivers: [
              ...
              sliver: SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text('/5', style: TextStyle(color: Colors.grey.shade600, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ],
                    ),
                    ...
                    Text(
                      product.description,
                      style: TextStyle(color: Colors.grey[600], height: 1.5, fontSize: context.responsiveTextSize(14)),
                    ),
            ...
            SliverPadding(
              ...
              sliver: SliverToBoxAdapter(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Reviews", style: TextStyle(fontSize: context.responsiveTextSize(18), fontWeight: FontWeight.bold)),
            ...
            // 5. Flattened Reviews List (The Fix)
            SliverPadding(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          CircleAvatar(
            radius: 20,
            backgroundImage: NetworkImage(review.userAvatar ?? "https://ui-avatars.com/api/?name=${review.userName}"),
          ),
              ...
              children: [
                ...
                Row(
                  children: List.generate(
                    5,
                    (i) => Icon(Icons.star, size: 14, color: i < review.rating ? Colors.amber : Colors.grey[300]),
                  ),
                ),
                const SizedBox(height: 6),
                Text(review.comment, style: TextStyle(color: Colors.grey[800], height: 1.4, fontSize: 13)),
              ],
            ),
          ),
        ],
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("\$${plant.price}", style: const TextStyle(color: Color(0xff50AD98), fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              );
